...
async function fetchPlaces(types: string, search: string, pageParam: number = 0): Promise<PlacesResponse> {
...
export function PlaceGrid({
    ...
    const { data, isLoading, error, fetchNextPage, hasNextPage, isFetchingNextPage } = useInfiniteQuery({
        ...
        queryFn: ({ pageParam }) => fetchPlaces(activeTypes, searchQuery, pageParam),
        initialPageParam: 0,
