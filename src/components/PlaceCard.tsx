            ...
            <div className="p-4">
                ...
                <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                        {type === 'tour' || type === 'park' || type === 'tour_operator' ? (
                            <div className="flex items-center gap-2 text-[10px] font-black text-gray-600">
                                <span>{price_from ? (price_from.includes('ETB') || price_from.includes('$') ? `From ${price_from}` : `From $${price_from}`) : "Contact for pricing"}</span>
                                <span>•</span>
