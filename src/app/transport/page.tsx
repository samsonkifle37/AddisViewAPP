...
import { EthiopianAirlinesCard } from "@/components/EthiopianAirlinesCard";
import { CurrencyConverter } from "@/components/CurrencyConverter";
import { TelebirrGuide } from "@/components/TelebirrGuide";
...
const INTERCITY_BUSES = [
    {
         name: "Selam Bus",
         color: "bg-blue-600",
         route: "Addis → Bahir Dar, Gondar, Hawassa, Dire Dawa",
         price: "800 - 1500 ETB",
         phone: "8032",
    ...
    },
    {
         name: "Sky Bus",
         color: "bg-red-600",
         route: "Addis → Bahir Dar, Hawassa, Jimma",
         price: "750 - 1300 ETB",
         phone: "8033",
    ...
    },
    {
         name: "Abay Bus",
         color: "bg-green-600",
         route: "Addis → Dessie, Mekelle, Bahir Dar",
         price: "700 - 1200 ETB",
         phone: "8034",
